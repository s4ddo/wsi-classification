"""Native Sparse Attention DeepSeekSpatialViT with multi-branch sparse attention.

Uses three attention branches:
1. Compression: Compresses sequence into blocks
2. Selection: Selects top-k blocks
3. Sliding window: Local window attention
"""
import torch
