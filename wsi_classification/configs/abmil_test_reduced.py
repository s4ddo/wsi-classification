"""AB-MIL test config with reduced feature dimensions (256-dim).

Reduced from 1280-dim to 256-dim. Scale back to 1280-dim on stronger PC.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/abmil_test_reduced.py
"""
...
def get_config() -> ExperimentConfig:
    ...
    # Network: AB-MIL with reduced dimensions
