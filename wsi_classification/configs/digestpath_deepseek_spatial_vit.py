"""DeepSeek Spatial ViT config for DigestPath dataset.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/digestpath_deepseek_spatial_vit.py
"""
