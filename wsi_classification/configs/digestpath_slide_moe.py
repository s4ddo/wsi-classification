"""SlideMoE config for DigestPath dataset.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/digestpath_slide_moe.py
"""
...
# Ensure this matches where you save the model file below
...
def get_config() -> ExperimentConfig:
    ...
    config.wandb = WandbConfig(
        ...
        job_group="digestpath_slide_moe",
    )
