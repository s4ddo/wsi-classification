"""Native Sparse Attention DeepSeekSpatialViT config for Camelyon16 dataset.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/camely_nsa_deepseek_spatial_vit.py
"""
...
def get_config() -> ExperimentConfig:
    ...
    config.wandb = WandbConfig(
        ...
        job_group="camely_nsa_deepseek_spatial_vit",
    )
