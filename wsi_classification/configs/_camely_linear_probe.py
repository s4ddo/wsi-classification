"""LinearProbe classification config for Camelyon16 dataset.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/camely_linear_probe.py
"""
