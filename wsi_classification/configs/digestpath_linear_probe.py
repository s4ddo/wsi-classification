"""LinearProbe classification config for DigestPath dataset.

Simple linear probe with optional spatial encoding for testing embedding quality.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/digestpath_linear_probe.py
"""
...
from wsi_classification.models.linear_probe import LinearProbe
...
def get_config() -> ExperimentConfig:
    ...
    config.wandb = WandbConfig(
        ...
        job_group="digestpath_linear_probe",
    )
