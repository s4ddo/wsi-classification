"""Windowed DeepSeekSpatialViT config for DigestPath dataset.

Global-local windowed attention architecture.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/digestpath_window_deepseek_spatial_vit.py
"""
...
def get_config() -> ExperimentConfig:
    ...
    config.wandb = WandbConfig(
        ...
        job_group="digestpath_window_deepseek_spatial_vit",
    )
