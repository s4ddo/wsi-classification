"""Deformable DETR config for DigestPath dataset.

Multi-scale deformable attention with DeepSeek MoE.

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/digestpath_deformable_vit.py
"""
...
def get_config() -> ExperimentConfig:
    ...
    config.wandb = WandbConfig(
        ...
        job_group="digestpath_deformable_vit",
    )
