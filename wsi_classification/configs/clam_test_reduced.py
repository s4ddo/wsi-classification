"""CLAM_SB test config with reduced iterations for quick debugging.

Follows: https://github.com/mahmoodlab/clam

Usage:
    python -m wsi_classification.run --config wsi_classification/configs/clam_test_reduced.py
"""
...
BATCH_SIZE = 1
NUM_WORKERS = 4
TRAINING_ITERATIONS = 100  # Reduced for testing
...
def get_config() -> ExperimentConfig:
    ...
    # CLAM_SB model (reduced architecture for testing)
